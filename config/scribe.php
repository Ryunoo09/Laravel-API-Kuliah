...
return [
    ...
    'title' => 'Laravel 12 Tester — API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'RESTful API untuk manajemen Posts dan Comments dengan autentikasi berbasis Laravel Sanctum.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Dapatkan token dengan melakukan request <b>POST /api/v1/login</b> menggunakan email dan password Anda.',
    ],
